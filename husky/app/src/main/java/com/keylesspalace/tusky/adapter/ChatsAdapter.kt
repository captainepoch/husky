...
class ChatsViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    fun setupWithChat(
        ...
        if (payload == null) {
            displayName.text =
                chat.account.displayName?.emojify(chat.account.emojis, displayName, true)
                    ?: ""
            userName.text =
                userName.context.getString(R.string.status_username_format, chat.account.username)
            ...
            if (chat.lastMessage != null) {
                val text = if (chat.lastMessage.content != null) {
                    ...
                    content.resources.getString(
                        chat.lastMessage.attachment.describeAttachmentType()
                    )
...
class ChatsAdapter(
    private val dataSource: TimelineAdapter.AdapterDataSource<ChatViewData>,
