...
class ChatMessagesViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    private val mediaPreviewUnloaded =
        ColorDrawable(ThemeUtils.getColor(itemView.context, R.attr.colorBackgroundAccent))

    fun setupWithChatMessage(
        msg: ChatMessageViewData.Concrete,
...
class ChatMessagesAdapter(
    private val dataSource: TimelineAdapter.AdapterDataSource<ChatMessageViewData>,
